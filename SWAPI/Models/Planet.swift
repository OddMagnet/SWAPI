...
struct Planet: SWAPIData {
    ...
    static var resource: Endpoint.Resource = .planets
    ...
    /* TODO: flesh out model & OverviewView
     ...
     rotation_period string -- The number of standard hours it takes for this planet
        to complete a single rotation on its axis.
     orbital_period string -- The number of standard days it takes for this planet
...
extension Planet {
    static var example: Planet {
        Planet(name: "PLANET", url: "URL")
    }
}
